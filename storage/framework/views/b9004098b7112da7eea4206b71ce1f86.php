<?php $__env->startSection('panel'); ?>
    <div class="card">
        <div class="card-body">
            <div class="table-responsive--md table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $BusinessTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $businessType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($loop->iteration); ?></td>
                                <td>
                                    <?php echo e($businessType->lang('name')); ?>

                                </td>
                                <td><?php echo e(optional($businessType->businesscategory)->name); ?></td>
                                <td>
                                    <?php echo $businessType->statusBadge ?>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a href="<?php echo e(route('admin.businesstype.edit', $businessType->id)); ?>">
                                                    <i class="bi bi-pencil me-1"></i> <?php echo app('translator')->get('Edit'); ?>
                                                </a>
                                            </li>

                                            <?php if($businessType->status == Status::ENABLE): ?>
                                                <li>
                                                    <button class="confirmationBtn" data-question="<?php echo app('translator')->get('Are you sure to Inactive Property Type?'); ?>"
                                                        data-action="<?php echo e(route('admin.businesstype.status', $businessType->id)); ?>">
                                                        <i class="bi bi-eye-slash me-1"></i><?php echo app('translator')->get('Active'); ?></button>
                                                </li>
                                            <?php else: ?>
                                                <li>
                                                    <button class="confirmationBtn" data-question="<?php echo app('translator')->get('Are you sure to Inactive Property Type?'); ?>"
                                                        data-action="<?php echo e(route('admin.businesstype.status', $businessType->id)); ?>">
                                                        <i class="bi bi-eye-slash me-1"></i><?php echo app('translator')->get('Inactive'); ?></button>
                                                </li>
                                            <?php endif; ?>
                                        </ul>
                                    </div>
        ...
        <?php if($BusinessTypes->hasPages()): ?>
            <div class="card-footer pagination-card-footer">
                <?php echo e(paginateLinks($BusinessTypes)); ?>
...
<?php endif; ?>
        <a href="<?php echo e(route('admin.businesstype.create')); ?>" class="btn btn-primary"><i class="fa-solid fa-plus"></i>
            <?php echo app('translator')->get('Add New'); ?></a>
    </div>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', ['title' => 'Business Type'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/businesstypes/index.blade.php ENDPATH**/ ?>