    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo app('translator')->get('Share now'); ?></h5>
            ...
            shares: [
                {
                    ...
                    onClick: function () {
                        var productURL = "<?php echo e(route('property.detail', $property->slug)); ?>";
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/asoug/amlaek.asoug.com/resources/views/sections/share_section.blade.php ENDPATH**/ ?>