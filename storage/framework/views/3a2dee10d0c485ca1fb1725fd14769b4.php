                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="property-image">
                                            <a
                                                href="<?php echo e(getImage(getFilePath('event_news') . '/' . $event->image, getFileSize('event_news'))); ?>">
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <div class="flex-wrap gap-2 d-flex">
        <a href="<?php echo e(route('admin.event_news.index')); ?>" class="btn btn-primary"><i
                class="bi bi-arrow-clockwise pe-1"></i><?php echo app('translator')->get('Back'); ?></a>
        <a href="<?php echo e(route('admin.event_news.status', [$event->id, Status::INACTIVE])); ?>" class="btn btn-warning"><i
                class="bi bi-x pe-1"></i><?php echo app('translator')->get('Inactive'); ?></a>
        <a href="<?php echo e(route('admin.event_news.status', [$event->id, Status::ACTIVE])); ?>" class="btn btn-success"><i
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Event News Details'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/event_news/show.blade.php ENDPATH**/ ?>