...
<?php if($get == 'saved'): ?>
    <table class="messenger-list-item" data-contact="<?php echo e(Auth::user()->id); ?>">
        <tr data-action="0">
            ...
            <td>
                <p data-id="<?php echo e(Auth::user()->id); ?>" data-type="user"><?php echo e(__('Saved Messages')); ?> <span><?php echo e(__('You')); ?></span></p>
...
<?php /**PATH /home/amlaek/public_html/resources/views/vendor/Chatify/layouts/listItem.blade.php ENDPATH**/ ?>