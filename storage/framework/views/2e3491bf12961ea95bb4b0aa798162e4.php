...
<script>
    function initMapType() {
        var myLatLng = {
            lat: parseFloat("<?php echo e($event->latitude ?? null); ?>"),
            lng: parseFloat("<?php echo e($event->longitude ?? null); ?>"),
        };
        ...
        const marker = new google.maps.Marker({
            position: new google.maps.LatLng("<?php echo e($event->latitude); ?>", "<?php echo e($event->longitude); ?>"),
            map: map,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/amlaek/public_html/resources/views/admin/event/map.blade.php ENDPATH**/ ?>