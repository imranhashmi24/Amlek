    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="<?php echo e(route('admin.all_category.edit', $category->id)); ?>">
                ...
                <?php if($all_categories->hasPages()): ?>
                    <div class="card-footer pagination-card-footer">
                        <?php echo e(paginateLinks($all_categories)); ?>
...
<?php endif; ?>
        <a href="<?php echo e(route('admin.all_category.create')); ?>" class="btn btn-primary"> <i class="fa-solid fa-plus"></i><?php echo app('translator')->get('Add New'); ?></a>
    </div>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', ['title' => 'Categories'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/all_category/index.blade.php ENDPATH**/ ?>