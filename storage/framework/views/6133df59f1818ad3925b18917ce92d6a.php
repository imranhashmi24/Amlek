                ...
                <form action="" method="POST">
                    ...
                    <div class="card-body">
                        <div class="mb-3 form-group">
                            <label class="form-label"><?php echo app('translator')->get('Email Send Method'); ?></label>
                        ...
                        <div class="mt-4 row d-none configForm" id="smtp">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3 form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Host'); ?> </label>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3 form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Port'); ?> </label>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3 form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Encryption'); ?></label>
                                    <select class="form-control" name="enc">
                                        <option value="ssl" <?php if(@$general->mail_config->enc == 'ssl'): echo 'selected'; endif; ?>><?php echo app('translator')->get('SSL'); ?></option>
                                        <option value="tls" <?php if(@$general->mail_config->enc == 'tls'): echo 'selected'; endif; ?>><?php echo app('translator')->get('TLS'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mt-4 row d-none configForm" id="sendgrid">
                            ...
                            <div class="form-group col-md-12">
                                <label class="form-label"><?php echo app('translator')->get('App Key'); ?> </label>
                        ...
                        <div class="mt-4 row d-none configForm" id="mailjet">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Api Public Key'); ?> </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Api Secret Key'); ?> </label>
                ...
                <form action="<?php echo e(route('admin.setting.notification.email.test')); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3 form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Sent to'); ?> </label>
...
<?php echo $__env->make('admin.layouts.app',['title'=> 'Email Notification Settings'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/notification/email_setting.blade.php ENDPATH**/ ?>