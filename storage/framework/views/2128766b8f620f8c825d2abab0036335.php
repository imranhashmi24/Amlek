...
<?php $__env->startSection('panel'); ?>
	<div class="card">
		<div class="card-body">
			<form action="<?php echo e(route('admin.auction-category.update', $auctionCategory->id)); ?>" method="post"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image-uploader','data' => ['image' => ''.e(@$auctionCategory->image).'','name' => 'image','class' => 'w-100','type' => 'all_category']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['image' => ''.e(@$auctionCategory->image).'','name' => 'image','class' => 'w-100','type' => 'all_category']); ?>
					...
					<div class="col-md-8">
						...
						<div class="mb-3 form-group">
							...
							<select class="form-control" name="status">
								...
								<option value="1" <?php echo e(old('status', @$auctionCategory->status) == 1 ? 'selected' : ''); ?>><?php echo app('translator')->get('Active'); ?>
								</option>
								<option value="0" <?php echo e(old('status', @$auctionCategory->status) == 0 ? 'selected' : ''); ?>><?php echo app('translator')->get('Inactive'); ?>
								</option>
							</select>
						</div>
...
<?php echo $__env->make('admin.layouts.app', ['title' => @$title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\soudi-project\Amlek\resources\views/admin/auction_categories/edit.blade.php ENDPATH**/ ?>