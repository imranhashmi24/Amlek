                            ...
                            <div class="border shadow-none card">
                                <div class="p-0 card-body">
                                    ...
                                    <div class="card-list">
                                        ...
                                        <b>
                                            <?php echo e(@$serviceRequest->sectors); ?>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <div class="flex-wrap gap-2 d-flex">
        <a href="<?php echo e(route('admin.property.form.request.index')); ?>" class="btn btn-primary"><i
                class="bi bi-arrow-clockwise pe-1"></i><?php echo app('translator')->get('Back'); ?></a>

        <a href="<?php echo e(route('admin.property.form.request.status', [$serviceRequest->id, Status::REVIEW])); ?>" class="btn btn-success"><i
                class="bi bi-check2 pe-1"></i><?php echo app('translator')->get('Approved'); ?></a>
        <a href="<?php echo e(route('admin.property.form.request.status', [$serviceRequest->id, Status::REJECT])); ?>" class="btn btn-danger"><i
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Service Request Details'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/request/property_request/show.blade.php ENDPATH**/ ?>