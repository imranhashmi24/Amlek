            ...
            <?php echo csrf_field(); ?>
              <div class="modal-body">
                ...
                <div class="mb-3 form-group">
                    <label class="form-label"><?php echo app('translator')->get('Form Type'); ?></label>
                ...
                <div class="mb-3 form-group">
                    <label class="form-label"><?php echo app('translator')->get('Is Required'); ?></label>
                ...
                <div class="mb-3 form-group">
                    <label class="form-label"><?php echo app('translator')->get('Form Label'); ?></label>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/amlaek/public_html/resources/views/components/form-generator.blade.php ENDPATH**/ ?>