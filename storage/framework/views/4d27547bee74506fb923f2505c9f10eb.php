    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive--md table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $subpropertyTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subpropertyType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <div class="avatar avatar--sm">
                                                <img src="<?php echo e(getImage(getFilePath('propertyType') . '/' . $subpropertyType->image, getFileSize('propertyType'))); ?>"
                                                    alt="<?php echo app('translator')->get('Image'); ?>">
                                            </div>
                                        </td>
                                        <td>
                                            <?php echo e($subpropertyType->lang('name')); ?>

                                        </td>

                                        <td>
                                            <?php if(app()->getLocale() == 'en'): ?>
                                                <?php echo e(@$subpropertyType->property_type ? $subpropertyType->property_type->name : ''); ?>

                                            <?php else: ?>
                                                <?php echo e(@$subpropertyType->property_type ? $subpropertyType->property_type->name_ar : ''); ?>
                                        ...
                                        <td>
                                            <?php echo $subpropertyType->statusBadge ?>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a
                                                            href="<?php echo e(route('admin.sub.property.type.edit', $subpropertyType->id)); ?>">
                                                            <i class="bi bi-pencil me-1"></i> <?php echo app('translator')->get('Edit'); ?>
                                                        </a>
                                                    </li>
                                                    
                                                    <?php if($subpropertyType->status == Status::ENABLE): ?>
                                                        <li>
                                                            <button class="confirmationBtn"
                                                                data-question="<?php echo app('translator')->get('Are you sure to Inactive Sub Property Type?'); ?>"
                                                                data-action="<?php echo e(route('admin.sub.property.type.status', $subpropertyType->id)); ?>">
                                                                <i
                ...
                <?php if($subpropertyTypes->hasPages()): ?>
                    <div class="card-footer pagination-card-footer">
                        <?php echo e(paginateLinks($subpropertyTypes)); ?>
...
<?php endif; ?>
        <a href="<?php echo e(route('admin.sub.property.type.create')); ?>" class="btn btn-primary"><i class="fa-solid fa-plus"></i>
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Sub Property Type'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/sub_property_type/index.blade.php ENDPATH**/ ?>