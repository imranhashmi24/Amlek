        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="mb-3 col-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        <label class="form-label"><?php echo app('translator')->get('Property'); ?> <span class="text-danger fs-6">*</span></label>
                        <div class="input-group">
        ...
        <div class="mb-3 col-12 col-md-12 col-lg-12">
            <div class="form-group">
                ...
                <select name="status" class="form-control" required>
                    ...
                    <option <?php echo e(old('status') == 3 ? 'selected' : ''); ?> value="2"><?php echo app('translator')->get('Finished'); ?></option>
                </select>
            </div>
        </div>
        <div class="col-12">
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Create Auction'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/auction/create.blade.php ENDPATH**/ ?>