                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="avatar avatar--sm">
                                                <img src="<?php echo e(getImage(getFilePath('blog') . '/' . $blog->image)); ?>"
                                                    alt="Image">
                                            </div>
                                        </td>
                                        <td> <?php echo e($blog->lang('title')); ?> </td>
                                                    ...
                                                    <?php if($blog->status == 'active'): ?>
                                                        <li>
                                                            ...
                                                            <button class="confirmationBtn"
                                                                data-question="<?php echo app('translator')->get('Are you sure to inactive this blog?'); ?>"
                                                                data-action="<?php echo e(route('admin.blog.status', $blog->id)); ?>">
                                                                <i class="bi bi-eye pe-1"></i><?php echo app('translator')->get('Inactive'); ?>
                                                            </button>
                                                        </li>
                                                    <?php else: ?>
                                                        <li>
                                                            ...
                                                            <button class="confirmationBtn"
                                                                data-question="<?php echo app('translator')->get('Are you sure to active this blog?'); ?>"
                                                                data-action="<?php echo e(route('admin.blog.status', $blog->id)); ?>">
                                                                <i class="bi bi-eye-slash pe-1"></i><?php echo app('translator')->get('Active'); ?>
                                                            </button>
                                                        </li>
                                                    <?php endif; ?>
                                                </ul>
...
<?php endif; ?>
        <a href="<?php echo e(route('admin.blog.create')); ?>" class="btn btn-primary"> <i
                class="bi bi-plus-lg pe-2"></i><?php echo app('translator')->get('Add New'); ?></a>
    </div>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', ['title' => 'Blogs'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/blog/index.blade.php ENDPATH**/ ?>