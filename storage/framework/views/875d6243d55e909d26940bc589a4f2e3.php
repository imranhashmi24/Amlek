        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.properties.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="construction_type" class="form-control" required>
                                ...
                                <option value="Under Construction" <?php if(old('construction_type') == 'Under Construction'): echo 'selected'; endif; ?>><?php echo app('translator')->get('Under Construction'); ?></option>
                    ...
                    <div class="mb-3 col-12 col-md-6 col-lg-4">
                        <div class="form-group">
                            <label class="form-label"><?php echo app('translator')->get('FAL Number'); ?></label>
                            <input type="text" name="fal" value="<?php echo e(old('fal')); ?>" class="form-control">
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="price" value="<?php echo e(old('price')); ?>" required
                                            class="form-control">
                            ...
                            <div class="mb-3 col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="sqr_price" value="<?php echo e(old('sqr_price')); ?>" required
                                            class="form-control">
                                        <span class="input-group-text"><?php echo e(gs('cur_sym')); ?></span>
                                    </div>
                                </div>
                    ...
                    <div class="product-card-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Features and Amenities'); ?> <span class="text-danger fs-6">*</span></label>
                                    <textarea name="features" class="form-control tinymceeditor" rows="2" required><?php echo e(old('features')); ?></textarea>
                                </div>
                            </div>
                            <div class="mb-3 col-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Features and Amenities'); ?> (<?php echo app('translator')->get('Arabic'); ?>) <span class="text-danger fs-6">*</span></label>
                                    <textarea name="features_ar" class="form-control tinymceeditor" rows="2" required><?php echo e(old('features_ar')); ?></textarea>
                                </div>
                            </div>
                            <div class="mb-3 col-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Fixtures and Fittings'); ?> <span class="text-danger fs-6">*</span></label>
                                    <textarea name="fixtures" class="form-control tinymceeditor" rows="2" required><?php echo e(old('fixtures')); ?></textarea>
                                </div>
                            </div>
                            <div class="mb-3 col-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Fixtures and Fittings'); ?> (<?php echo app('translator')->get('Arabic'); ?>) <span class="text-danger fs-6">*</span></label>
                                    <textarea name="fixtures_ar" class="form-control tinymceeditor" rows="2" required><?php echo e(old('fixtures_ar')); ?></textarea>
                                </div>
                            </div>

                            <div class="mb-3 col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Street'); ?> <span class="text-danger fs-6">*</span></label>
                            ...
                            <div class="mb-3 col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Width'); ?> <span class="text-danger fs-6">*</span></label>
                                    <input type="text" name="street_width" value="<?php echo e(old('street_width')); ?>" required
                                        class="form-control">
                                </div>
                            </div>
                            <div class="mb-3 col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Facing'); ?> <span class="text-danger fs-6">*</span></label>
                                    <input type="text" name="facing" value="<?php echo e(old('facing')); ?>" required
                                        class="form-control">
                                </div>
                            </div>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <a href="<?php echo e(route('admin.properties.index')); ?>" class="btn btn-primary"><i class="bi bi-arrow-clockwise"></i>
...
<?php echo $__env->make('admin.layouts.app', ['title' => 'Create Property'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/property/create.blade.php ENDPATH**/ ?>