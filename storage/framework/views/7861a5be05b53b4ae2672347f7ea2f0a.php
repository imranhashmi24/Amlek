<aside class="sidebar-wrapper" data-simplebar="true">
	...
	<ul class="metismenu sidebar__menu-main" id="menu">
		...
		<li
			...
			<ul>
				<li class="<?php echo e(menuActive('admin.country*')); ?>">
					<a href="<?php echo e(route('admin.country.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Countries'); ?></a>
				</li>
				...
				<li class="<?php echo e(menuActive('admin.property.type.area*')); ?>">
					<a href="<?php echo e(route('admin.property.type.area.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Property Type Areas'); ?></a>
				</li>
			</ul>
		</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.properties*')); ?>">
			...
			<ul>
				<li class="<?php echo e(menuActive('admin.properties.index')); ?>">
					<a href="<?php echo e(route('admin.properties.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('All Property'); ?></a>
				</li>
				...
				<li class="<?php echo e(menuActive('admin.properties.published')); ?>">
					<a href="<?php echo e(route('admin.properties.published')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Published Property'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.properties.review')); ?>">
					<a href="<?php echo e(route('admin.properties.review')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Review Property'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.properties.rejected')); ?>">
					<a href="<?php echo e(route('admin.properties.rejected')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Rejected Property'); ?></a>
				</li>
		...
		<li class="sidebar--menu sidebar--dropdown">
			...
			<ul>
				...
				<li class="<?php echo e(menuActive('admin.businesstype.index')); ?>">
					<a href="<?php echo e(route('admin.businesstype.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Business Type'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.businesspost.index')); ?>">
					<a href="<?php echo e(route('admin.businesspost.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Business Post'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.business.request*')); ?>">
					<a href="<?php echo e(route('admin.business.request.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Business Request'); ?></a>
				</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.auction-category*')); ?>">
			<a href="javascript:;" class="has-arrow">
				<div class="parent-icon"><i class="bi bi-house-gear"></i>
				</div>
				<div class="menu-title"><?php echo app('translator')->get('Categories'); ?></div>
				<span class="red__notify"></span>
			</a>
			<ul>
				<li class="<?php echo e(menuActive('admin.auction-category.index')); ?>">
					<a href="<?php echo e(route('admin.auction-category.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Categories'); ?></a>
				</li>

				<li class="<?php echo e(menuActive('admin.auction-category.create')); ?>">
					<a href="<?php echo e(route('admin.auction-category.create')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Add Category'); ?></a>
				</li>
			</ul>
		</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.auction*')); ?>">
			<a href="javascript:;" class="has-arrow">
				...
				<div class="menu-title"><?php echo app('translator')->get('Auctions'); ?></div>
				<span class="red__notify"></span>
			</a>
			<ul>

				<li class="<?php echo e(menuActive('admin.auction.index')); ?>">
					<a href="<?php echo e(route('admin.auction.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('All Auction'); ?></a>
				</li>
				...
				<li class="<?php echo e(menuActive('admin.auction.finished')); ?>">
					<a href="<?php echo e(route('admin.auction.finished')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Finished Auction'); ?></a>
				</li>

				<li class="<?php echo e(menuActive('admin.auction.current')); ?>">
					<a href="<?php echo e(route('admin.auction.current')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Current Auction'); ?>
						<span class="red__notify"></span>
					</a>
				</li>

				<li class="<?php echo e(menuActive('admin.auction.upcoming')); ?>">
					<a href="<?php echo e(route('admin.auction.upcoming')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Upcoming Auction'); ?></a>
				</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.events*')); ?>">
			...
			<ul>
				<li class="<?php echo e(menuActive('admin.events.index')); ?>">
					<a href="<?php echo e(route('admin.events.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('All Events'); ?></a>
				</li>
				...
				<li class="<?php echo e(menuActive('admin.events.pending')); ?>">
					<a href="<?php echo e(route('admin.events.pending')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Pending Events'); ?></a>
				</li>
			</ul>
		</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.property.request*')); ?>">
			...
			<ul>
				<li class="<?php echo e(menuActive('admin.property.request.index')); ?>">
					<a href="<?php echo e(route('admin.property.request.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('All Request'); ?></a>
				</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.service.request*')); ?>">
			...
			<ul>
				<li class="<?php echo e(menuActive('admin.service.request.index')); ?>">
					<a href="<?php echo e(route('admin.service.request.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('All Request'); ?></a>
				</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.finance.request*')); ?>">
			...
			<ul>
				<li class="<?php echo e(menuActive('admin.finance.request*')); ?>">
					<a href="<?php echo e(route('admin.finance.request.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('All Request'); ?></a>
				</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.auction.request*')); ?>">
			...
			<ul>
				<li class="<?php echo e(menuActive('admin.auction.request.index')); ?>">
					<a href="<?php echo e(route('admin.auction.request.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('All Request'); ?></a>
				</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.users*')); ?>">
			...
			<ul>
				<li class="<?php echo e(menuActive('admin.users.active')); ?>">
					<a href="<?php echo e(route('admin.users.active')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Active Users'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.users.banned')); ?>">
					<a href="<?php echo e(route('admin.users.banned')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Banned Users'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.users.unverified')); ?>">
					<a href="<?php echo e(route('admin.users.email.unverified')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Email Unverified'); ?>
				...
				<li class="<?php echo e(menuActive('admin.users.all')); ?>">
					<a href="<?php echo e(route('admin.users.all')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('All Users'); ?></a>
				</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.report*')); ?>">
			...
			<ul>
				<li class="<?php echo e(menuActive('admin.report.login.history')); ?>">
					<a href="<?php echo e(route('admin.report.login.history')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Login History'); ?></a>
				</li>
		...
		<li
			...
			<ul>
				...
				<li class="<?php echo e(menuActive('admin.extensions.index')); ?>">
					<a href="<?php echo e(route('admin.extensions.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Extensions'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.language.manage')); ?>">
					<a href="<?php echo e(route('admin.language.manage')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Language'); ?></a>
				</li>
				...
				<li class="<?php echo e(menuActive('admin.maintenance.mode')); ?>">
					<a href="<?php echo e(route('admin.maintenance.mode')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Maintenance Mode'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.setting.cookie')); ?>">
					<a href="<?php echo e(route('admin.setting.cookie')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('GDPR Cookie'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.setting.custom.css')); ?>">
					<a href="<?php echo e(route('admin.setting.custom.css')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Custom CSS'); ?></a>
				</li>
			</ul>
		</li>
		...
		<li class="sidebar--menu sidebar--dropdown <?php echo e(menuActive('admin.support*')); ?>">
			...
			<ul>
				...
				<li class="<?php echo e(menuActive('admin.support.closed')); ?>">
					<a href="<?php echo e(route('admin.support.closed')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Closed Support'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.support.answered')); ?>">
					<a href="<?php echo e(route('admin.support.answered')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('Answered Support'); ?></a>
				</li>
				<li class="<?php echo e(menuActive('admin.support.index')); ?>">
					<a href="<?php echo e(route('admin.support.index')); ?>"><i class="bi bi-record-circle"></i><?php echo app('translator')->get('All Support'); ?></a>
				</li>
			</ul>
		</li>
...
<?php /**PATH D:\soudi-project\Amlek\resources\views/admin/partials/sidenav.blade.php ENDPATH**/ ?>