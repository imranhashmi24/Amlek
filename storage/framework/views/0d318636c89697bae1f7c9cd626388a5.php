        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h5 class="text-center"><?php echo e(@$floor_title); ?></h5>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('floorPlanRequestStore')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="plan" value="<?php echo e($floor_title); ?>">
                        <div class="row">
                            ...
                            <div class="mt-3 mb-3 col-12">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Detail'); ?> <span class="text-danger fs-6">*</span></label>
                                    <textarea name="detail" rows="4" class="form-control" required><?php echo e(old('detail')); ?></textarea>
                                </div>
                            </div>
...
<?php echo $__env->make('web.layouts.frontend', ['title' => __("Floor Plan Request")], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/asoug/amlaek.asoug.com/resources/views/web/request/floor_plan_request.blade.php ENDPATH**/ ?>