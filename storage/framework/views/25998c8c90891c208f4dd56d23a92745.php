<?php $__env->startPush('seo'); ?>
    <meta name="title" Content="<?php echo e(@$assetLiabilitie->lang('title')); ?>">
    <meta name="description" content="<?php echo e(@$assetLiabilitie->lang('title')); ?>">
    ...
    <meta name="apple-mobile-web-app-title" content="<?php echo e(@$assetLiabilitie->lang('title')); ?>">
    
    <meta itemprop="name" content="<?php echo e(@$assetLiabilitie->lang('title')); ?>">
    <meta itemprop="description" content="<?php echo e(@$assetLiabilitie->lang('title')); ?>">
    <meta itemprop="image" content="<?php echo e(getImage('assets/images/frontend/offer_banner/' . @$promotion->data_values->image)); ?>">
    
    <meta property="og:type" content="website">
    <meta property="og:title" content="<?php echo e(@$assetLiabilitie->lang('title')); ?>">
    <meta property="og:description" content="<?php echo e(@$assetLiabilitie->lang('title')); ?>">
    <meta property="og:image" content="<?php echo e(getImage('assets/images/frontend/offer_banner/' . @$promotion->data_values->image)); ?>"/>
        ...
        <div class="container">
            <div class="row">
                <div class="py-5 col-12">
                    <h1 class="py-5 m-0 text-center"></h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0"><?php echo e(@$assetLiabilitie->lang('title')); ?></h4>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('asset.liability.request.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('web.layouts.frontend', ['title' => @$assetLiabilitie->lang('title')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/asoug/amlaek.asoug.com/resources/views/web/asset_liabilitie_request.blade.php ENDPATH**/ ?>