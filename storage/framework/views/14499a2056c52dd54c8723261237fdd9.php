...
<script>
    function initMapType() {
        var myLatLng = {
            lat: parseFloat("<?php echo e($property->latitude ?? null); ?>"),
            lng: parseFloat("<?php echo e($property->longitude ?? null); ?>"),
        };
        ...
        const marker = new google.maps.Marker({
            position: new google.maps.LatLng("<?php echo e($property->latitude); ?>", "<?php echo e($property->longitude); ?>"),
            map: map,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/asoug/amlaek.asoug.com/resources/views/web/component/map.blade.php ENDPATH**/ ?>