<div class="pb-4 col-12">
    <div class="sort-links">
        <div>
            ...
            ?>
            <a href="<?php echo e(route('property', array_merge($search, ['tab' => 'list']))); ?>" class="<?php echo e($tab == 'list' ? 'active' : ''); ?>"><?php echo app('translator')->get('List View'); ?></a>
            <a href="<?php echo e(route('property', array_merge($search, ['tab' => 'map']))); ?>" class="<?php echo e($tab == 'map' ? 'active' : ''); ?>"><?php echo app('translator')->get('View real estate map'); ?></a>
        </div>
    </div>
</div>
<?php /**PATH /home/asoug/amlaek.asoug.com/resources/views/web/component/property_tab.blade.php ENDPATH**/ ?>