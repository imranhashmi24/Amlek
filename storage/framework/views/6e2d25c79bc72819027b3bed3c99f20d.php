                                        ...
                                        <td>
                                            <div class="gap-2 d-flex align-items-center">
                                                <div class="avatar avatar--sm">
                                                    <img src="<?php echo e(getImage(getFilePath('event_news') . '/' . $event->image, getFileSize('event_news'))); ?>"
                                                        alt="<?php echo app('translator')->get('Image'); ?>">
                                                </div>
                                                <a
                                                    href="<?php echo e(route('admin.event_news.show', $event->id)); ?>"><?php echo e(strLimit($event->title, 15)); ?></a>
                                            </div>
                                        </td>
                                        <td>
                                            <a
                                                href="<?php echo e(route('admin.event_news.show', $event->id)); ?>"><?php echo e(strLimit($event->title_ar, 15)); ?></a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a href="<?php echo e(route('admin.event_news.edit', $event->id)); ?>">
                                                            <i class="bi bi-pencil me-1"></i> <?php echo app('translator')->get('Edit'); ?>
                                                        </a>
                                                    </li>
                                                    <li><a href="<?php echo e(route('admin.event_news.show', $event->id)); ?>"> <i
...
<?php endif; ?>
        <a href="<?php echo e(route('admin.event_news.create')); ?>" class="btn btn-primary"><i class="fa-solid fa-plus"></i><?php echo app('translator')->get('Add New'); ?></a>
    </div>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', ['title' => 'Event News'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/admin/event_news/index.blade.php ENDPATH**/ ?>