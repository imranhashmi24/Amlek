...
?>
    ...
    <section class="py-5">
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('request.store.auction_request', $requestAuction->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php echo $__env->make('web.layouts.frontend', ['title' => __($title)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/asoug/amlaek.asoug.com/resources/views/web/request/auction_request.blade.php ENDPATH**/ ?>