<?php $__env->startSection('content'); ?>
    ...
    <section class="py-5">
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('request.store.property_request', $requestProperty->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php echo $__env->make('web.layouts.frontend', ['title' => @$title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/amlaek/public_html/resources/views/web/request/property_request.blade.php ENDPATH**/ ?>