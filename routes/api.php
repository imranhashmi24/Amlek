...
Route::controller(ApiController::class)->group(function () {
    ...
    Route::get('ai-service', 'aiService');
    ...
    Route::group(['prefix' => 'pages'], function(){
        ...
        Route::get('floor-plan-details/{id}', 'floorPlanDetail');
        Route::get('blogs', 'blogs');
        Route::get('blog-details/{slug}', 'blogDetails');

        Route::get('property-requests', 'propertyRequestPage');
        Route::get('property-request-details/{id}', 'propertyRequestDetails');
        
        
         // foreign page routes
        Route::get('foreign-ownership-banner', 'foreignOwnershipBanner');
        Route::get('foreign-property-development', 'foreignPropertyDevelopment');
        Route::get('foreign-we-offer-you', 'foreignWeOfferYou');
        Route::get('foreign-our-service', 'foreignOurService');
        Route::get('foreign-why-choose-us', 'foreignWhyChooseUs');


        // foreign page request routes

        Route::post('foreign-ownership-request', 'foreignOwnershipRequest');

        // event route
        Route::get('event-banner', 'eventBanner');
...
Route::get('auction-banner', [AuctionController::class,'auctionBanner']);
...
Route::controller(ApiController::class)->group(function () {
    ...
    Route::post('ai-service-request', 'aiServiceStore');
    Route::post('floor-plan-request-send', 'floorPlanRequestStore');
});
