...
Route::middleware('admin')->group(function () {
    ...
    // auction route
    Route::group(['prefix' => 'auction-category', 'as' => 'auction-category.'], function () {
        Route::get('/', [AuctionCategoryController::class, 'index'])->name('index');
        Route::get('/create', [AuctionCategoryController::class, 'create'])->name('create');
        Route::post('/store', [AuctionCategoryController::class, 'store'])->name('store');
        Route::post('/update/{id}', [AuctionCategoryController::class, 'update'])->name('update');
        Route::get('/edit/{id}', [AuctionCategoryController::class, 'edit'])->name('edit');
        Route::get('/show/{id}', [AuctionCategoryController::class, 'show'])->name('show');
        Route::post('destroy/{id}', [AuctionCategoryController::class, 'destroy'])->name('destroy');
    });
