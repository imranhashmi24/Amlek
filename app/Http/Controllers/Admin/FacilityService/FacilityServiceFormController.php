...
class FacilityServiceFormController extends Controller
{

    public $model = FacilityServiceForm::class;
    public $searchable = ['name', 'name_ar'];
    public $view = "admin.facility_services.forms";
    public $route = "admin.facility_services.forms";
    public $redirect = "admin.facility_services.forms";
    public $notify = "FacilityServiceForm";
    ...
    public function edit($service_id, $id)
    {
        ...
        return view($this->view . '.edit', compact('form', 'service_id', 'route', 'title', 'pageTitle'));
    }
