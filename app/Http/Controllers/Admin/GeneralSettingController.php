...
class GeneralSettingController extends Controller
{
    ...
    {
        $timezones = json_decode(file_get_contents(resource_path('views/admin/partials/timezone.json')), true);
        
        $currentTimezoneKey = array_search(config('app.timezone'), $timezones);
        
        $currentTimezone = array_values($timezones)[$currentTimezoneKey];
