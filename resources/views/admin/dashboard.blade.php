        ...
        <div class="col">
            <div class="border-0 card radius-10 border-start border-success border-3">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="">
                            <p class="mb-1">@lang('Total Property')</p>
                            <h4 class="mb-0 text-success">{{$widget['propertyCount']}}</h4>
                        </div>
        ...
        <div class="col">
            <div class="border-0 card radius-10 border-start border-secondary border-3">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="">
                            <p class="mb-1">@lang('Total Property Request')</p>
                            <h4 class="mb-0 text-secondary">{{$widget['propertyRequestCount']}}</h4>
                        </div>
        ...
        <div class="col">
            <div class="border-0 card radius-10 border-start border-success border-3">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="">
                            <p class="mb-1">@lang('Total Service Request')</p>
                            <h4 class="mb-0 text-success">{{$widget['serviceRequestCount']}}</h4>
                        </div>
                        <div class="text-white ms-auto widget-icon bg-success">
                            <i class="bi bi-bag-check-fill"></i>
                        </div>
        ...
        <div class="col">
            <div class="border-0 card radius-10 border-start border-secondary border-3">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="">
                            <p class="mb-1">@lang('Total Finance')</p>
                            <h4 class="mb-0 text-secondary"> {{ $widget['financeRequestCount']}} </h4>
                        </div>
                        <div class="text-white ms-auto widget-icon bg-secondary">
                            <i class="bi bi-bag-check-fill"></i>
                        </div>
