					...
					<div class="col-md-8">
						...
						<div class="mb-3 form-group">
							...
							<select class="form-control" name="status">
								...
								<option value="1" {{ old('status', @$auctionCategory->status) == 1 ? 'selected' : '' }}>@lang('Active')
								</option>
								<option value="0" {{ old('status', @$auctionCategory->status) == 0 ? 'selected' : '' }}>@lang('Inactive')
								</option>
							</select>
						</div>
