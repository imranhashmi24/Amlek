@extends('admin.layouts.app', ['title' => 'Ai Form Request'])
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                        ...
                        <table class="table">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th>@lang('Contract Type')</th>
                                    <th>@lang('Contract Sealing Date')</th>
                                    <th>@lang('Contract Sealing Location')</th>
                            ...
                            @forelse ($serviceRequests as $serviceRequest)
                                <tr>
                                    ...
                                    <td>
                                        {{@$serviceRequest->contract_type}}
                                    </td>
                                    <td>
                                        {{@$serviceRequest->contract_sealing_date}}
                                    </td>

                                    <td>
                                        {{@$serviceRequest->contract_sealing_location}}
                                    </td>
                                    <td>
                                        {{@$serviceRequest->tenant_name}}
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a href="{{ route('admin.ai_service.form.request.show', $serviceRequest->id) }}">
