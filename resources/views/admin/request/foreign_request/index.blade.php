@extends('admin.layouts.app', ['title' => __('Foreign Form Request')])
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                        ...
                        <table class="table">
                            ...
                            @forelse ($serviceRequests as $serviceRequest)
                                <tr>
                                    ...
                                    <td>
                                        @if(app()->getLocale() == 'en')
                                            {{@$serviceRequest->nation?->name}}
                                        @else
                                            {{@$serviceRequest->nation?->name_ar}}
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a href="{{ route('admin.foreign.form.request.show', $serviceRequest->id) }}">
