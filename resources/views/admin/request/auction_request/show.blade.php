@extends('admin.layouts.app', ['title' => 'Auction Request Details'])
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                            ...
                            <div class="border shadow-none card">
                                <div class="p-0 card-body">
                                    ...
                                    <div class="card-list">
                                        ...
                                        <b>
                                            @if (app()->getLocale() == 'en')
                                            {{ @$serviceRequest->auction?->title }}
                                            @else
                                            {{ @$serviceRequest->auction?->title_ar }}
                                            @endif
                                        </b>
                                    </div>
                                    <div class="card-list">
...
@push('breadcrumb-plugins')
    <div class="flex-wrap gap-2 d-flex">
        <a href="{{ route('admin.auction.request.index') }}" class="btn btn-primary"><i
                class="bi bi-arrow-clockwise pe-1"></i>@lang('Back')</a>

        <a href="{{ route('admin.auction.request.status', [$serviceRequest->id, Status::REVIEW]) }}" class="btn btn-success"><i
                class="bi bi-check2 pe-1"></i>@lang('Approved')</a>
        <a href="{{ route('admin.auction.request.status', [$serviceRequest->id, Status::REJECT]) }}" class="btn btn-danger"><i
