@extends('admin.layouts.app', ['title' => 'Create Property'])
@section('panel')
    <div class="card">
        <div class="card-body">
                    ...
                    <div class="mb-3 col-12 col-md-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="construction_type" class="form-control" required>
                                ...
                                <option value="Under Construction" @selected(old('construction_type') == 'Under Construction')>@lang('Under Construction')</option>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="sqr_price" value="{{ old('sqr_price') }}" required
                                            class="form-control">
                                        <span class="input-group-text">{{ gs('cur_sym') }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="features" class="form-control tinymceeditor" rows="2" required>{{ old('features') }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 col-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">@lang('Features and Amenities') (@lang('Arabic')) <span class="text-danger fs-6">*</span></label>
                                    <textarea name="features_ar" class="form-control tinymceeditor" rows="2" required>{{ old('features_ar') }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 col-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">@lang('Fixtures and Fittings') <span class="text-danger fs-6">*</span></label>
                                    <textarea name="fixtures" class="form-control tinymceeditor" rows="2" required>{{ old('fixtures') }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 col-12 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">@lang('Fixtures and Fittings') (@lang('Arabic')) <span class="text-danger fs-6">*</span></label>
                                    <textarea name="fixtures_ar" class="form-control tinymceeditor" rows="2" required>{{ old('fixtures_ar') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    <label class="form-label">@lang('Width') <span class="text-danger fs-6">*</span></label>
                                    <input type="text" name="street_width" value="{{ old('street_width') }}" required
                                        class="form-control">
                                </div>
                            </div>
                            <div class="mb-3 col-12 col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="facing" value="{{ old('facing') }}" required
                                        class="form-control">
                                </div>
                            </div>
