    ...
    <ul class="metismenu sidebar__menu-main" id="menu">
        ...
        <li
            ...
            <ul>
                ...
                <li class="{{ menuActive('admin.property.type.area*') }}">
                    <a href="{{ route('admin.property.type.area.index') }}"><i
                            class="bi bi-record-circle"></i>@lang('Property Type Areas')</a>
                </li>
            </ul>
        </li>
        ...
        <li class="sidebar--menu sidebar--dropdown {{ menuActive('admin.properties*') }}">
            ...
            <ul>
                <li class="{{ menuActive('admin.properties.index') }}">
                    <a href="{{ route('admin.properties.index') }}"><i
                            class="bi bi-record-circle"></i>@lang('All Property')</a>
                </li>
                ...
                <li class="{{ menuActive('admin.properties.published') }}">
                    <a href="{{ route('admin.properties.published') }}"><i
                            class="bi bi-record-circle"></i>@lang('Published Property')</a>
                </li>
                <li class="{{ menuActive('admin.properties.review') }}">
                    <a href="{{ route('admin.properties.review') }}"><i
                            class="bi bi-record-circle"></i>@lang('Review Property')</a>
                </li>
                <li class="{{ menuActive('admin.properties.rejected') }}">
                    <a href="{{ route('admin.properties.rejected') }}"><i
                            class="bi bi-record-circle"></i>@lang('Rejected Property')</a>
                </li>
        ...
        <li class="sidebar--menu sidebar--dropdown">
            ...
            <ul>
                ...
                <li class="{{ menuActive('admin.businesstype.index') }}">
                    <a href="{{ route('admin.businesstype.index') }}"><i
                            class="bi bi-record-circle"></i>@lang('Business Type')</a>
                </li>
                <li class="{{ menuActive('admin.businesspost.index') }}">
                    <a href="{{ route('admin.businesspost.index') }}"><i
                            class="bi bi-record-circle"></i>@lang('Business Post')</a>
                </li>
                <li class="{{ menuActive('admin.business.request*') }}">
                    <a href="{{ route('admin.business.request.index') }}"><i
                            class="bi bi-record-circle"></i>@lang('Business Request')</a>
                </li>
        ...
        <li class="sidebar--menu sidebar--dropdown {{ menuActive('admin.auction*') }}">
            <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">@lang('Manage Auctions')</div>
                <span class="red__notify"></span>
            </a>
            <ul>
                <li class="{{ menuActive('admin.auction.index') }}">
                    <a href="{{ route('admin.auction.index') }}"><i
                            class="bi bi-record-circle"></i>@lang('All Auction')</a>
                </li>
                ...
                <li class="{{ menuActive('admin.auction.finished') }}">
                    <a href="{{ route('admin.auction.finished') }}"><i
                            class="bi bi-record-circle"></i>@lang('Finished Auction')</a>
                </li>
                <li class="{{ menuActive('admin.auction.current') }}">
                    <a href="{{ route('admin.auction.current') }}"><i
                        class="bi bi-record-circle"></i>@lang('Current Auction')
                        <span class="red__notify"></span>
                    </a>
                </li>
                <li class="{{ menuActive('admin.auction.upcoming') }}">
                    <a href="{{ route('admin.auction.upcoming') }}"><i
                            class="bi bi-record-circle"></i>@lang('Upcoming Auction')</a>
                </li>
        ...
        <li class="sidebar--menu sidebar--dropdown {{ menuActive('admin.property.request*') }}">
            ...
            <ul>
                <li class="{{ menuActive('admin.property.request.index') }}">
                    <a href="{{ route('admin.property.request.index') }}"><i
        ...
        <li class="sidebar--menu sidebar--dropdown {{ menuActive('admin.finance.request*') }}">
            ...
            <ul>
                <li class="{{ menuActive('admin.finance.request*') }}">
                    <a href="{{ route('admin.finance.request.index') }}"><i
                            class="bi bi-record-circle"></i>@lang('All Request')</a>
                </li>
        ...
        <li class="sidebar--menu sidebar--dropdown {{ menuActive('admin.auction.request*') }}">
            ...
            <ul>
                <li class="{{ menuActive('admin.auction.request.index') }}">
                    <a href="{{ route('admin.auction.request.index') }}"><i
                            class="bi bi-record-circle"></i>@lang('All Request')</a>
                </li>
