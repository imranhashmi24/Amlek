                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @forelse($orders as $order)
                                    <tr>
                                        <td>
                                            {{ $order?->service($order->type, $order->service_id)?->title ?? $order?->service($order->type, $order->service_id)?->name }}
                                        </td>

                                        @foreach (getRequestOrderUserInfos($order->form_data) as $formData)
                                        <td>
                                            {{ $formData ?? __('N/A') }}
                                        </td>
                                        @endforeach
