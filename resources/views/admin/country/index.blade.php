                        ...
                        <table class="table">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th>@lang('Cities')</th>
                                    <th>@lang('Property Type Areas')</th>
                            ...
                            <tbody>
                                ...
                                @forelse($countries as $country)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.property.type.area.index') }}?search={{ $country->name }}"
                                                class="badge bg-primary rounded-pill ms-auto">{{ $country->property_type_area_count }}</a>
                                        </td>
                                        <td>
                                            {{ $country->sort_order }}
                                        </td>
