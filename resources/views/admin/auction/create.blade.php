@extends('admin.layouts.app', ['title' => 'Create Auction'])
@section('panel')
							...
							<div class="mb-3 col-12 col-md-6 col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="number" name="auction_day" value="{{ old('auction_day') }}" required class="form-control">
									</div>
								</div>
							</div>
							<div class="mb-3 col-12 col-md-6 col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="date" name="auction_date" value="{{ old('auction_date') }}" required class="form-control">
									</div>
								</div>
							</div>
							<div class="mb-3 col-12 col-md-6 col-lg-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="datetime-local" name="beginning_time" value="{{ old('beginning_time') }}" class="form-control">
									</div>
								</div>
							</div>
							...
							<div class="mb-3 col-12 col-md-12 col-lg-12">
								<div class="form-group">
									...
									<select name="status" class="form-control" required>
										...
										<option {{ old('status') == 0 ? 'selected' : '' }} value="0">@lang('Pending')</option>
										<option {{ old('status') == 1 ? 'selected' : '' }} value="1">@lang('Current')</option>
										<option {{ old('status') == 2 ? 'selected' : '' }} value="2">@lang('Upcoming')</option>
										<option {{ old('status') == 3 ? 'selected' : '' }} value="3">@lang('Finished')</option>
									</select>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="make_ar" value="{{ old('make_ar') }}" class="form-control">
						</div>
					</div>
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
					...
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="model_ar" value="{{ old('model_ar') }}" class="form-control">
						</div>
					</div>
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							<label class="form-label">@lang('Year')</label>
							<input type="number" name="year" value="{{ old('year') }}" class="form-control" min="1900"
								max="2099">
						</div>
					</div>
					<div class="mb-3 col-12 col-md-6 col-lg-4">
					...
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="vin" value="{{ old('vin') }}" class="form-control">
						</div>
					</div>
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							<label class="form-label">@lang('Title Status')</label>
							<input type="text" name="title_status" value="{{ old('title_status') }}" class="form-control"
					...
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="engine" value="{{ old('engine') }}" class="form-control"
					...
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="drivetrain" value="{{ old('drivetrain') }}" class="form-control"
					...
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="body_style" value="{{ old('body_style') }}" class="form-control"
								placeholder="Sedan">
						</div>
					</div>
					<!-- Exterior Color -->
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="exterior_color" value="{{ old('exterior_color') }}" class="form-control"
					...
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="interior_color" value="{{ old('interior_color') }}" class="form-control"
								placeholder="Soaring">
						</div>
					</div>
					<!-- Owner Count -->
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="owner_count" value="{{ old('owner_count') }}" class="form-control"
								placeholder="1 Owner">
						</div>
					</div>
					<!-- Seller Name -->
					...
					<div class="mb-3 col-12 col-md-6 col-lg-4">
						<div class="form-group">
							...
							<select name="seller_type" class="form-control">
								...
								<option value="Private Party" {{ old('seller_type') == 'Private Party' ? 'selected' : '' }}>@lang('Private Party')
								</option>
								<option value="Dealer" {{ old('seller_type') == 'Dealer' ? 'selected' : '' }}>@lang('Dealer')</option>
							</select>
						</div>
					</div>
					<!-- Highlights (textarea) -->
					...
					<div class="mb-3 col-12 col-md-12">
						<div class="form-group">
							...
							<textarea name="seller_notes" class="form-control" rows="3">{{ old('seller_notes') }}</textarea>
						</div>
					</div>
					...
					<div class="mb-3 col-12 col-md-12">
						<div class="form-group">
							...
							<textarea name="other_items" class="form-control" rows="3">{{ old('other_items') }}</textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="product-card-body">
				<div class="row">
					...
					<div class="mb-3 col-12 col-md-6">
						...
						<input type="number" step="0.5" name="bathrooms" value="{{ old('bathrooms') }}" class="form-control">
					</div>
					<div class="mb-3 col-12 col-md-6">
						<label class="form-label">@lang('Square Footage')</label>
						<input type="number" name="sqft" value="{{ old('sqft') }}" class="form-control">
					</div>
					<div class="mb-3 col-12 col-md-6">
						<label class="form-label">@lang('Lot Size')</label>
						<input type="text" name="lot_size" value="{{ old('lot_size') }}" class="form-control"
							placeholder="e.g. 0.25 acres">
					</div>
					<div class="mb-3 col-12 col-md-6">
						<label class="form-label">@lang('Year Built')</label>
						<input type="number" name="year_built" value="{{ old('year_built') }}" class="form-control">
					</div>
					<div class="mb-3 col-12 col-md-6">
					...
					<div class="mb-3 col-12 col-md-12">
						...
						<textarea name="re_features" class="form-control" rows="3">{{ old('re_features') }}</textarea>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="product-card-body">
				<div class="row">
					<div class="mb-3 col-12 col-md-6">
						...
						<input type="text" name="era" value="{{ old('era') }}" class="form-control"
					...
					<div class="mb-3 col-12 col-md-6">
						...
						<select name="condition" class="form-control">
							<option value="">@lang('Select')</option>
							<option value="Mint">@lang('Mint')</option>
							<option value="Excellent">@lang('Excellent')</option>
							<option value="Good">@lang('Good')</option>
							<option value="Fair">@lang('Fair')</option>
							<option value="Poor">@lang('Poor')</option>
						</select>
					</div>
					<div class="mb-3 col-12 col-md-6">
						<label class="form-label">@lang('Provenance')</label>
						<input type="text" name="provenance" value="{{ old('provenance') }}" class="form-control">
					</div>
					<div class="mb-3 col-12 col-md-6">
					...
					<div class="mb-3 col-12 col-md-12">
						...
						<textarea name="antique_notes" class="form-control" rows="3">{{ old('antique_notes') }}</textarea>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="product-card-body">
				<div class="row">
					<div class="mb-3 col-12 col-md-6">
						...
						<input type="text" name="species" value="{{ old('species') }}" class="form-control">
					</div>
					<div class="mb-3 col-12 col-md-6">
						<label class="form-label">@lang('Breed')</label>
						<input type="text" name="breed" value="{{ old('breed') }}" class="form-control">
					</div>
					<div class="mb-3 col-12 col-md-6">
						<label class="form-label">@lang('Age')</label>
						<input type="text" name="animal_age" value="{{ old('animal_age') }}" class="form-control"
					...
					<div class="mb-3 col-12 col-md-6">
						...
						<input type="text" name="health_records" value="{{ old('health_records') }}" class="form-control"
							placeholder="Vaccinated, dewormed">
					</div>
					<div class="mb-3 col-12 col-md-12">
						<label class="form-label">@lang('Additional Info')</label>
						<textarea name="animal_info" class="form-control" rows="3">{{ old('animal_info') }}</textarea>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="product-card-body">
				<div class="row">
					<div class="mb-3 col-12 col-md-6">
						...
						<input type="text" name="produce_type" value="{{ old('produce_type') }}" class="form-control"
					...
					<div class="mb-3 col-12 col-md-12">
						...
						<textarea name="produce_notes" class="form-control" rows="3">{{ old('produce_notes') }}</textarea>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="mb-3 col-12 col-md-4">
						<div class="form-group">
							...
							<x-image-uploader class="w-100" name="thumb_image" type="auction_thumb" />
						</div>
					</div>
