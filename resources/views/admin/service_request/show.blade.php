                        ...
                        <div class="col-md-6">
                            <div class="border shadow-none card">
                                <div class="p-0 card-body">
                                    ...
                                    <div class="card-list">
                                        <span>@lang('Type')</span>
                                        <b>{{ @$serviceRequest->type }}</b>
                                    </div>
                                    
                                     <div class="card-list">
                                        <span>@lang('Service Type')</span>
...
@push('breadcrumb-plugins')
    <div class="flex-wrap gap-2 d-flex">
        <a href="{{ route('admin.service.request.index') }}" class="btn btn-primary"><i
                class="bi bi-arrow-clockwise pe-1"></i>@lang('Back')</a>

        <a href="{{ route('admin.service.request.status', [$serviceRequest->id, Status::REVIEW]) }}" class="btn btn-success"><i
                class="bi bi-check2 pe-1"></i>@lang('Approved')</a>
        <a href="{{ route('admin.service.request.status', [$serviceRequest->id, Status::REJECT]) }}" class="btn btn-danger"><i
