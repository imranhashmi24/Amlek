@extends('web.layouts.master', ['title' => 'Edit Property'])
@section('content')
            ...
            <div class="row">
                ...
                <div class="mb-3 col-12 col-md-6 col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="title_ar"
                            value="{{ old('title_ar', @$property->title_ar) }}" class="form-control">
                    </div>
                </div>
                <div class="mb-3 col-12 col-md-6 col-lg-4">
                    <div class="form-group">
                ...
                <div class="mb-3 col-12 col-md-6 col-lg-4">
                    <div class="form-group">
                        ...
                        <select name="construction_type" class="form-select">
                ...
                <div class="mb-3 col-12 col-md-6 col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="fal" value="{{ old('fal', @$property->fal) }}"
                            class="form-control">
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="property_type_id" class="form-select">
                            ...
                            @foreach ($propertyTypes as $type)
                                <option value="{{ $type->id }}" @selected(old('property_type_id', @$property->property_type_id == @$type->id)) data-subpropertytypes="{{ $type->subproperty_types }}">
                                    {{ $type->lang('name') }}
                                </option>
                            @endforeach
                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="sqr_price"
                                        value="{{ old('sqr_price', @$property->sqr_price) }}"
                                        class="form-control">
                                    <span class="input-group-text">{{ gs('cur_sym') }}</span>
                                </div>
                            </div>
                        ...
                        <div class="mb-3 col-12 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="reference_no"
                                    value="{{ old('reference_no', @$property->reference_no) }}"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="address-input" name="address" class="form-control map-input" value="{{ @$property->address }}">
                                <input type="hidden" name="latitude" id="address-latitude" value="{{ @$property->latitude }}" />
                                <input type="hidden" name="longitude" id="address-longitude" value="{{ @$property->longitude }}" />
                            </div>
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="features" class="form-control tinymceeditor" rows="2">{{ old('features', @$property->features) }}</textarea>
                            </div>
                        </div>
                        <div class="mb-3 col-12 col-md-6">
                            <div class="form-group">
                                <label class="form-label">@lang('Features and Amenities') (@lang('Arabic'))</label>
                                <textarea name="features_ar" class="form-control tinymceeditor" rows="2">{{ old('features_ar', @$property->features_ar) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="street_width"
                                    value="{{ old('street_width', @$property->street_width) }}"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="mb-3 col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="facing"
                                    value="{{ old('facing', @$property->facing) }}" class="form-control">
                            </div>
                        </div>
                        <div class="mb-3 col-12 col-md-6 col-lg-6">
                            <div class="form-group">
...
@push('script')
    <script>
        console.log("{{ $property->city_id }}");
        $('[name=country_id]').on('change', function() {
            var cities = $(this).find('option:selected').data('cities');
            var option = '';
            $.each(cities, function(index, value) {
                var name = "{{ app()->getLocale() }}" == 'en' ? value.name : value.name_ar;
                option += "<option value='" + value.id + "' " + (value.id == "{{ $property->city_id }}" ? "selected" : "") + "data-lat='" + value.lat +"' data-lng='"+value.lng+"'>" +
                    name + "</option>";
            });
        ...
        function subPropetyTypes(subpropertyTypes)
        {
            ...
            $.each(subpropertyTypes, function(index, value) {
                var name = "{{ app()->getLocale() }}" == 'en' ? value.name : value.name_ar;
                option += "<option value='" + value.id + "'" + (value.id == "{{ @$property->subproperty_type_id }}" ? " selected" : "") + ">" + name + "</option>";
            });
