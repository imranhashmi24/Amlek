...
@endphp
    ...
    <section class="py-5">
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('marketing.request.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                <div class="form-group">
                                    <label>{{ __('Choose marketing services according to sectors') }}<span class="text-danger fs-6">*</span></label>
                            ...
                            <div class="mt-3 mb-3 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="activity" rows="4" class="form-control" required>{{ old('activity') }}</textarea>
                                </div>
                            </div>
