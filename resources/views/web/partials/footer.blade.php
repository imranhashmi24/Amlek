        ...
        <div class="row">
            <div class="col-12 col-lg-3">
                <div class="footer-left">
                    ...
                    <p> <i class="mx-2 fa fa-envelope"></i>
                        <a href="mailto:{{ @$footerContents->data_values->email }}">
                    ...
                    <div class="mb-3 social-media-link">
                        ...
                        <ul class="d-flex">
                            @foreach ($socialMediaElements as $socialMediaElement)
                                <li class="mx-2">
                                    <a href="{{ @$socialMediaElement->data_values->link }}" target="_blank">
            ...
            <div class="col-12 col-lg-6">
                <div class="footer-title">
                    <h5 class="pb-3 text-white"> @lang('Sectors') </h5>
                </div>
                        ...
                        <div class="row">
                            @foreach ($propertyTypes as $propertyType)
                                <div class="pb-2 col-6">
                                    <li>
                                        <a href="{{ route('property', ['tab' => 'list','property_type' => $propertyType->id]) }}">
                                            {{ $propertyType->lang('name') }} </a>
                                    </li>
                                </div>
                            @endforeach
                            <div class="pb-2 col-6">
                                <li>
                                    <a href="{{route('rehabilitation.empowerment')}}">
                                        @lang('Rehabilitation Empowerment') </a>
                                </li>
                            </div>
                        </div>
                    </ul>
            ...
            <div class="col-12 col-lg-3">
                ...
                <div class="footer-link">
                    <ul>
                        ...
                        @endforeach
                        <li>
                            <a href="{{ route('property') }}">@lang('Search for properties')</a>
                        </li>
                        <li>
                        ...
                        @foreach ($policyPages as $policyPage)
                            <li>
                                <a
                                    ...
                                    {{ __($policyPage->data_values->title) }} </a>
                            </li>
                        @endforeach
