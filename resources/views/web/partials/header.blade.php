                    ...
                    <ul>
                        ...
                        @guest
                            <li class="sub-btn button1">
                                <a href="#"> <i class="fa fa-user-circle"></i> @lang('Accounts') <i
                                ...
                                <div class="sub-menu">
                                    ...
                                    <a href="{{ route('user.register') }}"> <i
                                            class="fa-solid fa-arrow-right-to-bracket"></i> @lang('Sign Up')</a>
            ...
            <div class="col-md-10 d-none d-xl-block">
                <div class="menubar">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('auctions') }}"> @lang('Auctions') </a>
                        </li>
...
<div class="offcanvas offcanvas-mobile-menu {{ $lang == 'ar' ? 'offcanvas-end' : 'offcanvas-start' }}" tabindex="-1"
    ...
    <div class="offcanvas-body">
        <div class="canvas-mobile-menu">
            ...
            <a href="{{ route('auctions') }}"><i class="bi bi-chevron-right"></i> @lang('Auctions') </a>
