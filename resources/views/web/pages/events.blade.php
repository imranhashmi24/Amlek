...
<section class="py-5 pages-banner" style="background-image: url({{ getImage('assets/images/frontend/event_banner/' . @$eventBannerContent->data_values->image, '1900x250') }});
    height: 300px; background-size: cover;">
    <div class="container">
        <div class="row">
            <div class="py-5 col-12">
                <h1>{{ @$eventBannerContent->lang('title') }}</h1>
                <hr class="primary-color theme-hr">
                <p class="w-s-100">{!! @$eventBannerContent->lang('description') !!}</p>
