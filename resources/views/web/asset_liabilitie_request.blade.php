@extends('web.layouts.frontend', ['title' => @$assetLiabilitie->lang('title')])
@push('seo')
    <meta name="title" Content="{{ @$assetLiabilitie->lang('title') }}">
    <meta name="description" content="{{ @$assetLiabilitie->lang('title') }}">
    ...
    <meta name="apple-mobile-web-app-title" content="{{ @$assetLiabilitie->lang('title') }}">
    {{--<!-- Google / Search Engine Tags -->--}}
    <meta itemprop="name" content="{{ @$assetLiabilitie->lang('title') }}">
    <meta itemprop="description" content="{{ @$assetLiabilitie->lang('title') }}">
    <meta itemprop="image" content="{{ getImage('assets/images/frontend/offer_banner/' . @$promotion->data_values->image) }}">
    {{--<!-- Facebook Meta Tags -->--}}
    <meta property="og:type" content="website">
    <meta property="og:title" content="{{ @$assetLiabilitie->lang('title') }}">
    <meta property="og:description" content="{{ @$assetLiabilitie->lang('title') }}">
    <meta property="og:image" content="{{ getImage('assets/images/frontend/offer_banner/' . @$promotion->data_values->image) }}"/>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">{{ @$assetLiabilitie->lang('title') }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{route('asset.liability.request.store')}}" method="POST">
                        @csrf
                        <div class="mb-3">
